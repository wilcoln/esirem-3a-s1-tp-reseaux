...
# Création d'un fichier out.nam et définition des couleurs
...
proc attach-expoo-traffic { node sink size burst idle rate couleur } {
...
#On appelle la fonction a-e-t 3 fois pour réaliser une meme fonction
